...
export const sqlTeamRepository = {
...
export const sqlDepartmentRepository = {
...
export const sqlNotificationRepository = {
...
export const sqlAuditRepository = {
  async record(
    scope: TenantScope,
    entry: {
...
export const sqlOrganizationRepository = {
